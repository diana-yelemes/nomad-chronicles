...
const Footer = () => {
  return (
    <footer className='mb-4'>
      <div className='rounded-tr-3xl rounded-tl-3xl pt-12 xl:pt-20 pb-8 max-padd-container'>
        <h3 className='h3'>Explore history in an innovative way!</h3>
        <p>Forget about thick books, learn about historical figures through interactive AI.</p>
        ...
        <div className='flex justify-between flex-wrap gap-2'>
          <div className='max-w-sm'>
            ...
            <Link to={'/'} className='flex-1 flex items-center justify-start'>
              ...
              <h4 className='bold-24'>Nomad Chronicles</h4>
            </Link>
            <p className='py-4'>Unveiling the Past: Interactive Journeys Through Kazakh Heritage!</p>
      ...
      {/* copyrights */}
      <p className='text-white bg-tertiary medium-14 py-2 px-8 rounded flexBetween '><span>2025 Nomad Chronicles</span><span>All rights reserved</span></p>
    </footer>
  )
}
